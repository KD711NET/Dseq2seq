...
	seasondata and K1_train: Key scripts for extracting grid points from CORA dataset (used for training). Example shown for one fold in k-fold cross-validation.
