...
% Select validation time slice (slice 4 to 5)
slice2 = [indices(4):indices(5)];
...
% Process each point in study area for validation set
for i = 1:length(mall)
    ...
    folder_path = 'C:\code\pythonProject9\pythonProject1\K1_diurvalid\';
    ...
    new_filename = ['C:\code\pythonProject9\pythonProject1\K1_diurvalid\',mstr, '.csv'];
